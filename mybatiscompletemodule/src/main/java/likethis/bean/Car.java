...
public class Car implements Serializable {
    ...
    public Character getProduceTime() {
        return produceTime;
    }

    public void setProduceTime(Character produceTime) {
    ...
    public Car(Long id, String carNum, String brand, Double guidePrice, Character produceTime, String carType) {
        this.id = id;
        this.carNum = carNum;
        this.brand = brand;
        this.guidePrice = guidePrice;
